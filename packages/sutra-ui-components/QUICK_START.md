# Sutra UI Components - Quick Start Guide
...
### Card Composition
```typescript
import { Card, CardHeader, CardContent, CardActions, Button } from '@sutra/ui-components';
...
```typescript
import { Input } from '@sutra/ui-components';
...
### Badge for Status
```typescript
import { Badge } from '@sutra/ui-components';
